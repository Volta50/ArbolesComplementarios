...
Para determinar si dos árboles binarios son complementarios se propuso primero revisar cada caso de poda en ambos árboles para comprobar los casos en los cuales sus hojas coincidían. No obstante, este algoritmo sería muy caro de utilizar, especialmente en árboles de tamaño medio y mayor, teniendo en cuenta la naturaleza exponencial de un árbol binario.
